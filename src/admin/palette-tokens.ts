...
export const PALETTE_TOKENS: readonly PaletteToken[] = [
  ...
  // ─── Depth jewel-tone palette (depth-1 soft pink; depth-2…17 cycle red→orange→green→blue→purple, ending on red) ───
  { name: "depth-1", label: "Depth 1 (pink)", group: "depth", alpha: false, defaultValue: "#baaaaa" },
  { name: "depth-2", label: "Depth 2 (red)", group: "depth", alpha: false, defaultValue: "#9a0000" },
  { name: "depth-3", label: "Depth 3 (orange)", group: "depth", alpha: false, defaultValue: "#a36600" },
  { name: "depth-4", label: "Depth 4 (green)", group: "depth", alpha: false, defaultValue: "#1c701e" },
  { name: "depth-5", label: "Depth 5 (blue)", group: "depth", alpha: false, defaultValue: "#2b51c5" },
  { name: "depth-6", label: "Depth 6 (purple)", group: "depth", alpha: false, defaultValue: "#5200a3" },
  { name: "depth-7", label: "Depth 7 (red)", group: "depth", alpha: false, defaultValue: "#9a0000" },
  { name: "depth-8", label: "Depth 8 (orange)", group: "depth", alpha: false, defaultValue: "#a36600" },
  { name: "depth-9", label: "Depth 9 (green)", group: "depth", alpha: false, defaultValue: "#1c701e" },
  { name: "depth-10", label: "Depth 10 (blue)", group: "depth", alpha: false, defaultValue: "#2b51c5" },
  { name: "depth-11", label: "Depth 11 (purple)", group: "depth", alpha: false, defaultValue: "#5200a3" },
  { name: "depth-12", label: "Depth 12 (red)", group: "depth", alpha: false, defaultValue: "#9a0000" },
  { name: "depth-13", label: "Depth 13 (orange)", group: "depth", alpha: false, defaultValue: "#a36600" },
  { name: "depth-14", label: "Depth 14 (green)", group: "depth", alpha: false, defaultValue: "#1c701e" },
  { name: "depth-15", label: "Depth 15 (blue)", group: "depth", alpha: false, defaultValue: "#2b51c5" },
  { name: "depth-16", label: "Depth 16 (purple)", group: "depth", alpha: false, defaultValue: "#5200a3" },
  { name: "depth-17", label: "Depth 17 (red)", group: "depth", alpha: false, defaultValue: "#9a0000" },
] as const;
